...
## Adding a prefix to 2nd dataset
# %%
from voice_commands.dataset import add_prefix_to_files
from pathlib import Path

add_prefix_to_files(folder_path='..\data\processed\processed_2nd_group', prefix="mikr_")
# %%
